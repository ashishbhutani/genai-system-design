...
I am planning to write about **Speculative Decoding** next—it's basically the "cheat code" for making big models type faster. Or should we dive into **MQA/GQA** architectures first since we touched on them in the interview cases?
