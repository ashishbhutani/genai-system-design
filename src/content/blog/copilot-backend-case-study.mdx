...
Code autocomplete is one of the few GenAI products where the latency constraint
is non-negotiable. If a suggestion arrives after the developer has already
