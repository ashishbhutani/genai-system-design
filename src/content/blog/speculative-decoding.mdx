...
In a senior GenAI system design interview, expect these scenarios:

* **The "Slow Typer"**: Your 70B model streams at 8 tokens/s. How do you speed it up without a smaller model? (Answer: **Speculative Decoding**)
* **The "Wasted GPU"**: You deploy speculation; GPU utilization spikes but throughput doesn't. Why? (Answer: **Low acceptance rate**)
* **The "Which Draft?" Decision**: Should you use a 1B or 7B draft model? (Answer: **Draft speed vs. accuracy tradeoff**)
* **The Batch Size Killer**: Why does speculation hurt performance at 200 concurrent requests? (Answer: **Compute bottleneck shifts**)
...
You can't just deploy this blindly. You must monitor α and tune *K* based on your workload.
